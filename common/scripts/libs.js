var __ = (function (__) {
  ...
  var common = (function () {
    ...
    getDevicePixelRatio = function () {
      ...
      return window.devicePixelaRatio;
    },
    c = 'chrome',
    f = 'firefox',
    s = 'safari',
    ...
    var browser = {};
    browser.isIE = document.uniqueID;//(ua.indexOf('msie') >= 0 || ua.indexOf('trident') >= 0);
    browser.isEdge = is('edge/');
    //(/msie\s(\d+)/.test(ua) || /trident\s(\d+)/.test(ua)) ? true : false;
  ...
  __.viewport = (function(){
    ...
    if(__.device.isMobile){
      ...
      viewport = function(params) {
        ...
        document.write('<meta name="viewport" content="width=device-width,target-densitydpi=device-dpi,initial-scale=' + params['initial-scale'] + ',minimum-scale=' + params['minimum-scale']+ ',maximum-scale=' + params['maximum-scale'] + ', user-scalable=' + params['user-scalable']+ '" />');
